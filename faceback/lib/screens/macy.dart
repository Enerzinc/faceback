...
class MacyScreen extends StatelessWidget {
  const MacyScreen({super.key});
  @override
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: const Color.fromARGB(249, 250, 252, 255),
                border: Border.all(
            ...
            Column(
              children: [
                const Padding(
                    ...
                    child:
                        Text("g00D mUrN1n6", style: TextStyle(fontSize: 16))),
                SizedBox(child: Image.asset('assets/images/mcy_post.jpg')),
              ],
            ),
            const Row(
              children: [
