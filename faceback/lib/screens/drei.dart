...
class DreiScreen extends StatelessWidget {
  const DreiScreen({super.key});
                      ...
                      children: [
                        ClipOval(
                            child: SizedBox(
                                ...
                                width: 48,
                                child:
                                    Image.asset('assets/images/ja_pfp.jpg'))),
                      ],
                    ),
                    const SizedBox(
                      width: 10,
