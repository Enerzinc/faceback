...
class MartinScreen extends StatelessWidget {
  const MartinScreen({super.key});
          ...
          children: [
                ...
                const Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Studies Computer Engineering at Don Honorio Ventura State University',
                          softWrap: true,
                      ...
                      children: [
                        ClipOval(
                            child: SizedBox(
                                ...
                                width: 48,
                                child:
                                    Image.asset('assets/images/nrd_pfp.jpg'))),
                      ],
                    ),
                    const SizedBox(
                      width: 10,
            ...
            Column(
              children: [
                ...
                SizedBox(child: Image.asset('assets/images/test.jpg')),
              ],
            ),
            const Row(
              children: [
