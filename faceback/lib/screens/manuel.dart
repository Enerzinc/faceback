          ...
          children: [
            ...
            const Padding(
              ...
              child: Align(
                alignment: Alignment.centerLeft,
                child: Text(
                  'Embrace the rainbow with your hair',
                  style: TextStyle(
                      fontSize: 20,
                ...
                const Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        'Lives in San Fernando, Pampanga',
                        softWrap: true,
                        style: TextStyle(fontSize: 17),
                      )
                    ],
            ...
            Column(
              children: [
                const Padding(
                    ...
                    child: Text("meow", style: TextStyle(fontSize: 16))),
